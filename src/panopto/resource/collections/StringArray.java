 ...
 * 
 */
package panopto.resource.collections;

abstract public class StringArray
{
    protected String[] stringArray;
    protected String[] getStringArray(){return this.stringArray;}
    protected void setStringArray(String[] stringArray){this.stringArray = stringArray;}
}
